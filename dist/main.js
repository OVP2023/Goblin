...
var MoveGoblin = /*#__PURE__*/function () {
  function MoveGoblin() {
    _classCallCheck(this, MoveGoblin);
  }
  _createClass(MoveGoblin, [{
    key: "deactivateGoblin",
    value: function deactivateGoblin(index) {
      document.getElementById("hole".concat(index)).className = 'hole';
    }
  }, {
    key: "activateGoblin",
    value: function activateGoblin(index) {
      document.getElementById("hole".concat(index)).className = 'hole hole_has-mole';
    }
  }, {
    key: "countGoblin",
    value: function countGoblin(index) {
